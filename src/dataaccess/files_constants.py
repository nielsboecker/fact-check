...
GENERATED_NEURAL_NETWORK_MODEL = GENERATED_BASE_PATH + 'NN_model.p'
GENERATED_NEURAL_NETWORK_LOSS_HISTORY = GENERATED_BASE_PATH + 'NN_loss_history.p'
GENERATED_NN_PREPROCESSED_TRAINING_DATA = GENERATED_BASE_PATH + 'NN_preprocessed_training_data.p'
GENERATED_NN_PREPROCESSED_DEV_DATA = GENERATED_BASE_PATH + 'NN_preprocessed_dev_data.p'
GENERATED_ENTAILMENT_PREPROCESSED_DATA = GENERATED_BASE_PATH + 'entailment_baseline_preprocessed_{}.tsv'
