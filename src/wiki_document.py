...
# TODO: make sure comes as raw string
p1 = WikiDocument(r'{"id": "Hello", "text": "Hello is a salutation or greeting in the English language . It is first attested in writing from 1826 . ", "lines": "0\tHello is a salutation or greeting in the English language .\tsalutation\tsalutation\tgreeting\tgreeting habits\tEnglish language\tEnglish language\n1\tIt is first attested in writing from 1826 .\n2\t"}')
